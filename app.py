    ...
    completion = openai.ChatCompletion.create(
        ...
        messages=[
            ...
            {"role": "user", "content": """In the following input, I am going to give you a text you
             ...
             and burstiness. Keep that information in mind while writing. Minimum: 300, Maximum: 700, Text: """ + blogPost}
...
st.title('mlhGPT 🚀')
st.subheader(
    'Now, You Can Generate Images, Analyze Current Crypto Prices, and Search The Web With mlhGPT')
